...
<head>
    <meta charset="UTF-8">
    <title>Editar Categoría - MACARO</title>
...
<div class="header">
    ...
    <div>
        <a href="?action=categorias" class="btn-primario" style="text-decoration: none; padding: 10px 15px; background: #6c757d;">Cancelar</a>
    </div>
</div>
...
<div style="background: var(--fondo-tarjetas); padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); max-width: 600px; margin: 0 auto;">
    ...
    <form method="POST" action="index.php?action=editar_categoria">
        ...
        <div style="margin-bottom: 20px;">
            <label style="font-weight: bold; margin-bottom: 5px; display: block;">Nombre de la Categoría:</label>
            <input type="text" name="nombre" value="<?php echo htmlspecialchars($catActual['nombre']); ?>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; box-sizing: border-box;">
        </div>
